...
function TestConsumer() {
  ...
  return (
    <div>
      ...
      <button onClick={() => setAuth('tok123', { id: '1', firstName: 'Alice', email: 'a@b.com', avatarUrl: null, city: 'Paris', role: 'user', emailConfirmed: false })}>
        login
      </button>
...
describe('AuthContext', () => {
  ...
  it('initializes from localStorage', () => {
    const user = { id: '1', firstName: 'Bob', email: 'b@b.com', avatarUrl: null, city: 'Lyon', role: 'user', emailConfirmed: true };
